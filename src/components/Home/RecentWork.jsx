  ...
  function SamplePrevArrow(props) {
    ...
    return (
      <div className="slide">
        ...
        <div>
        <img src={showcase1} alt="Advertising agency in India" />
        </div>
        <div>
        <img src={showcase2} alt="Advertising agency near raipur chhattisgarh" />
        </div>
        <div>
        <img src={showcase3} alt="advertising and marketing agency in raipur" />
        </div>
        <div>
        <img src={showcase4} alt="social media marketing agency" />
        </div>
        <div>
        <img src={showcase5} alt="digital marketing agencies" />
        </div>
        <div>
        <img src={showcase6} alt="digital marketing agency near me" />
        </div>
        
    </Slider>
    <Link to={'/Portfolio'}><button type='button'  aria-label="Go to Portfolio">See more...</button></Link>
      </div>
    )
}
